...
<form role="form" action="configuracion" method="post" id="formuser'.$usersmodal[id_user].'">
     <div class="modal-dialog modal-lg">
        <div class="modal-content animated rotateInUpRight">
...
<form role="form" action="configuracion" method="post" id="formuserpass'.$usersmodal[id_user].'">

...
<body class="gray-bg" style="background-image:url(assets/images-galeria/.jpg);">
    ...
    <div class="loginColumns animated fadeInDown">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p class="text-center"><i class="fa fa-user-md icon-login"></i></p>
  ...
  <div class="modal inmodal fade" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <script type="text/javascript" src="core/controller/login/busca_pregunta.js"></script>
                        <script type="text/javascript" src="core/controller/login/valida_pregunta.js"></script>
                                <div class="form-group">

            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <form role="form" action="perfil" method="post" id="formuser">
        ...
        <div class="col-lg-4">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                <form role="form" action="perfil" method="post" id="formuserpass">
        ...
        <div class="col-lg-4">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                 <form role="form" action="perfil" method="post" id="formusersec">

<?php
session_start();
if(!$_SESSION['idUserInspinia']) {
	header('location: login');	
} 

$id_user = $_SESSION['idUserInspinia'];
...
if($info_user['security']==""){
    ...
    $warning[] = "Sin respuesta de seguridad. <br><br>Debe crearla en el modulo Perfil/Pregunta de Seguridad: <a type='submit' class='btn btn-warning block full-width m-b' href='perfil#pregunta'>Perfil</a>";
}
